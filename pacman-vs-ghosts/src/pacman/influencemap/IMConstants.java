...
public class IMConstants {
	...
	public static final double INFLUENCE_OF_PILL = 4;
	public static final double INFLUENCE_FACTOR_OF_PILL = 0.95;
	
	public static final double INFLUENCE_OF_GHOST = -80;
	public static final double INFLUENCE_OF_GHOST_LIMIT = -8;
	public static final double INFLUENCE_FACTOR_OF_GHOST = 0.95;
	
	public static final double INFLUENCE_OF_EDIBLE_GHOST = 60;
	public static final double INFLUENCE_FACTOR_OF_EDIBLE_GHOST = 0.95;
	
	public static final double INFLUENCE_OF_POWERPILL = 30;
	public static final double POWERPILL_DISTANCE_THRESHOLD_PER_GHOST = 110;
	public static final double INFLUENCE_FACTOR_OF_POWERPILL = 0.95;
	
	public static final double INFLUENCE_OF_FREEDOM_OF_CHOICE = 60;
