...
public final class Constants
{
	...
	public static final float GHOST_REVERSAL=0f;			//probability of a global ghost reversal event (0.0015f)	
	public static final int MAX_TIME=4000;					//maximum time a game can be played for (24000)
